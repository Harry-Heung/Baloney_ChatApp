...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class LifecycleLibraryAccessors extends SubDependencyFactory {
        private final LifecycleProcessLibraryAccessors laccForLifecycleProcessLibraryAccessors = new LifecycleProcessLibraryAccessors(owner);

        public LifecycleLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>lifecycle.process</b>
         */
        public LifecycleProcessLibraryAccessors getProcess() {
            return laccForLifecycleProcessLibraryAccessors;
        }

    }

    public static class LifecycleProcessLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public LifecycleProcessLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        /**
         * Dependency provider for <b>v251</b> with <b>androidx.lifecycle:lifecycle-process</b> coordinates and
         * with version reference <b>lifecycleProcessVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getV251() {
            return create("lifecycle.process.v251");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>lifecycleProcess</b> with value <b>2.8.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>lifecycleProcessVersion</b> with value <b>2.5.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getLifecycleProcessVersion() { return getVersion("lifecycleProcessVersion"); }
